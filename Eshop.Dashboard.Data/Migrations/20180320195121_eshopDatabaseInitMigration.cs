        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Psc = table.Column<int>(maxLength: 6, nullable: false),
                    State = table.Column<string>(maxLength: 255, nullable: false),
                    Telephone = table.Column<int>(maxLength: 12, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductNumber = table.Column<string>(maxLength: 255, nullable: true),
                    ProductPermUrl = table.Column<string>(maxLength: 1024, nullable: true),
                    ProductStateId = table.Column<Guid>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedWhem = table.Column<DateTime>(nullable: false),
                    OrderStateId = table.Column<Guid>(nullable: false),
                    ProcessedById = table.Column<Guid>(nullable: true),
                    ProcessingStartedWhem = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Orders_Users_ProcessedById",
